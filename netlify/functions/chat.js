...
// Uses Google Gemini 2.0 Flash (FREE tier via ai.google.dev — no subscription needed)
...
- If the question is outside your knowledge, OR the customer needs personalized help, pricing, bulk orders, complaints, or wants to talk to a real person — end your reply with exactly this token on its own line: SUGGEST_MESSENGER
- Do not include SUGGEST_MESSENGER unless it is genuinely needed.
